...
function buildBbbResult() {
  ...
  return [
    ...
    "",
    "Evidence: technical fields are generated from the currently applied/tested state; the explanation is generated by the configured Groq model from that recorded evidence."
  ].join("\n");
}
