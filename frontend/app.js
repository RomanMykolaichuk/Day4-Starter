...
function buildBbbResult() {
  ...
  return [
    ...
    "",
    "Evidence: generated by Day 4 Agent Starter from the currently applied/tested state."
  ].join("\n");
}
...
async function copyResultForBbb() {
  ...
  var result = buildBbbResult();
  try {
    await navigator.clipboard.writeText(result);
    ui.bbbStatus.textContent = "Copied";
    ...
    setError("Could not copy the BBB result. Select the preview text and copy it manually.");
  }
}
